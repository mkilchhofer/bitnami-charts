...
| `certgen.enabled`                                  | Certgen job creation                                                                                   | `true`                                                  |
| `certgen.image.registry`                           | Certgen image registry                                                                                 | `docker.io`                                             |
| `certgen.image.repository`                         | Certgen image name                                                                                     | `bitnami/contour`                                       |
| `certgen.image.tag`                                | Certgen image tag                                                                                      | `latest`                                                |
| `certgen.pullPolicy`                               | Certgen image pull policy                                                                              | `Always`                                                |
| `certgen.resources.limits`                         | Specify resource limits which the container is not allowed to succeed.                                 | `{}` (does not add resource limits to deployed pods)    |
| `certgen.resources.requests`                       | Specify resource requests which the container needs to spawn.                                          | `{}` (does not add resource limits to deployed pods)    |
| `certgen.nodeSelector`                             | Node labels for certgen pod assignment                                                                 | `{}`                                                    |
| `certgen.tolerations`                              | Tolerations for certgen pod assignment                                                                 | `[]`                                                    |
| `certgen.affinity`                                 | Affinity for certgen pod assignment                                                                    | `{}`                                                    |
| `certgen.podAnnotations`                           | Certgen Pod annotations                                                                                | `{}`                                                    |
| `certgen.serviceAccount.create`                    | create a serviceAccount for the certgen pod                                                            | `true`                                                  |
| `certgen.serviceAccount.name`                      | use the serviceAccount with the specified name                                                         | `""`                                                    |
| `certgen.securityContext.enabled`                  | If the pod should run in a securityContext.                                                            | `true`                                                  |
| `certgen.securityContext.runAsNonRoot`             | If the pod should run as a non root container.                                                         | `true`                                                  |
| `certgen.securityContext.runAsUser`                | define the uid with which the pod will run                                                             | `65534`                                                 |
| `certgen.securityContext.runAsGroup`               | define the gid with which the pod will run                                                             | `65534`                                                 |
| `certgen.initContainers`                           | Attach additional init containers to certgen pod (evaluated as a template)                             | `[]`                                                    |
| `certgen.extraVolumes`                             | Array to add extra volumes                                                                             | `[]`                                                    |
| `certgen.extraVolumeMounts`                        | Array to add extra mounts (normally used with extraVolumes)                                            | `[]`                                                    |
| `certgen.extraEnvVars`                             | Array containing extra env vars to be added to certgen container (evaluated as a template)             | `[]`                                                    |
| `certgen.extraEnvVarsConfigMap`                    | ConfigMap containing extra env vars to be added to certgen container (evaluated as a template)         | `""`                                                    |
| `certgen.extraEnvVarsSecret`                       | Secret containing extra env vars to be added to certgen container (evaluated as a template)            | `""`                                                    |
